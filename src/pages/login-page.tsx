...
const Login = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="h-screen grid lg:grid-cols-2 relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100"
    >
      {/* Left Side - Branding */}
      <BrandingSide />
              ...
              <div className="mt-6">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-white/80 px-3 py-1 text-slate-500 backdrop-blur-sm rounded-full font-medium">
                      Or continue with
                    </span>
                  </div>
                </div>
